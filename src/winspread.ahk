...
if (%0%) {
    ...
    MsgBox, 64, % Format("{:T} {:s} (rev. {:s})", base_name, git_version, git_revision), % "This program is intended to spread out windows across your desktop space. Check out <" name_ini "> [example] section for more information how to define your windows. Syntax is:`n`n" base_name ".exe section1 [section2 section3 ...]`n`n2019 © Orkan <orkans@gmail.com>`n" base_url
}
